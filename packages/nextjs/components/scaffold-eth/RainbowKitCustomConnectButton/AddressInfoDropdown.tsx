  ...
  return (
    <>
      <details ref={dropdownRef} className="dropdown dropdown-end leading-3">
        <summary className="btn btn-secondary btn-sm pl-1 pr-2 shadow-md dropdown-toggle gap-0 h-auto">
        ...
        <ul className="dropdown-content menu z-20 p-2 mt-2 rounded-xl border border-stone-200 bg-white shadow-lg gap-1">
