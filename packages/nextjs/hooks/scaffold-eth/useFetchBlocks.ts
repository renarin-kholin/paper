...
let testClient:
  | (ReturnType<typeof createTestClient> & ReturnType<typeof publicActions> & ReturnType<typeof walletActions>)
  | null = null;

const getTestClient = () => {
  // Only create client on client-side to avoid prerendering errors
