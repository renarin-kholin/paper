...
export default function DashboardPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto py-8 sm:py-12 page-fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 mb-10 sm:mb-12">
        ...
        <div className="bg-white p-5 sm:p-6 rounded-2xl border border-stone-200 shadow-sm lift-on-hover sm:col-span-2 md:col-span-1">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-full bg-stone-100 flex items-center justify-center text-stone-900">
